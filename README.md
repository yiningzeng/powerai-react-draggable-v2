...
[![gzip size](http://img.badgesize.io/https://npmcdn.com/powerai-react-draggable-v2/build/web/powerai-react-draggable-v2.min.js?compression=gzip)]()
[![version](https://img.shields.io/npm/v/powerai-react-draggable-v2.svg)]()
...
- [Demo](http://strml.github.io/powerai-react-draggable-v2/example/)
...
```bash
$ npm install powerai-react-draggable-v2
```

If you aren't using browserify/webpack, a
[UMD version of powerai-react-draggable-v2](dist/powerai-react-draggable-v2.js) is available. It is updated per-release only.
...
```js
// ES6
import Draggable from 'powerai-react-draggable-v2'; // The default
import {DraggableCore} from 'powerai-react-draggable-v2'; // <DraggableCore>
import Draggable, {DraggableCore} from 'powerai-react-draggable-v2'; // Both at the same time

// CommonJS
let Draggable = require('powerai-react-draggable-v2');
...
View the [Demo](http://strml.github.io/powerai-react-draggable-v2/example/) and its
...
// Default to 'powerai-react-draggable-v2', 'powerai-react-draggable-v2-dragging', and 'powerai-react-draggable-v2-dragged'
